    ...
    <View className="bg-my_gray rounded-2xl p-4 shadow-md shadow-black">
      ...
      <View className="flex-row items-center justify-between space-x-2 mt-4">
        ...
        <View className="flex-row items-center justify-between space-x-2">
          <TouchableOpacity className="bg-my_gray border border-my_gray_dark rounded-full px-4 py-2">
            <Text className="text-xs text-my_gray_dark font-semibold">
              Ignore
            </Text>
          </TouchableOpacity>
          <TouchableOpacity className="bg-my_accent rounded-full px-4 py-2">
            <Text className="text-xs text-white font-semibold">Accept</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
