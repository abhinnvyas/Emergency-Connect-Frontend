...
const RelatimeDetails = ({ UsersNearby, RequestsAccepted }) => {
  return (
    <View className="flex flex-row items-center justify-between space-x-2 mt-5">
      <View className="flex-1 bg-my_accent space-x-3 flex flex-row items-center justify-center px-2 py-4 rounded-3xl">
      ...
      <View className="flex-1 bg-my_primary space-x-3 flex flex-row  items-center justify-center px-2 py-4 rounded-3xl">
